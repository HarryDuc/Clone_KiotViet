...
export class BlogPostController {
  ...
  async addComment(
    ...
    return this.blogPostService.addComment(id, comment);
  }
  ...
  async removeComment(
    ...
    return this.blogPostService.removeComment(id, commentId);
  }

  @Post(':id/like')
  async like(@Param('id') id: string): Promise<BlogPost> {
    return this.blogPostService.like(id);
  }

  @Post(':id/unlike')
  async unlike(@Param('id') id: string): Promise<BlogPost> {
    return this.blogPostService.unlike(id);
  }
